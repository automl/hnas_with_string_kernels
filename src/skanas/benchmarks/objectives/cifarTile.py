...
from skanas.benchmarks.evaluation.train import training_pipeline
from skanas.benchmarks.evaluation.utils import (
...
class CifarTileObjective(Objective):
    ...
    def __call__(self, working_directory, previous_working_directory, architecture, **kwargs):
        start = time.time()
