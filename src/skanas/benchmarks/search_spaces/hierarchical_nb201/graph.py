...
import skanas.benchmarks.search_spaces.hierarchical_nb201.primitives as nb201_ops
from skanas.benchmarks.search_spaces.hierarchical_nb201.topologies import (
    Diamond3,
    NASBench201Cell,
    Residual3,
)
